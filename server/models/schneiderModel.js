...
const MeasurementSchema = new mongoose.Schema({
  ...
  panelname: { type: String, default: "Transformer Panel" },
  location: { type: String, default: "Near Entrance" },
});

// Define time-series schema for Schneider data
const SchneiderSchema = new mongoose.Schema(
  {
...
const SchneiderModel = mongoose.model("Schneider", SchneiderSchema);
module.exports = { SchneiderModel };
